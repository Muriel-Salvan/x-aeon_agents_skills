...
- Before executing anything, create a checklist named syncing-branch-with-base Execution Checklist with all steps of these instructions.
- The syncing-branch-with-base Execution Checklist must include all numbered steps explicitly.
- After completing each step of these instructions, mark the item in the syncing-branch-with-base Execution Checklist as completed.
- Do not skip any item.
- If an item cannot be executed, explicitly explain why.
- Never mark the task as completed while any item from the syncing-branch-with-base Execution Checklist remains open.
