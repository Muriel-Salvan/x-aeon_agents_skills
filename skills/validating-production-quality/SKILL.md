...
- Before executing anything, create a checklist named validating-production-quality Execution Checklist with all steps of these instructions.
- The validating-production-quality Execution Checklist must include all numbered steps explicitly.
- After completing each step of these instructions, mark the item in the validating-production-quality Execution Checklist as completed.
- Do not skip any item.
- If an item cannot be executed, explicitly explain why.
- Never mark the task as completed while any item from the validating-production-quality Execution Checklist remains open.
