---
name: improving-agent-reflection
...
When improving agent reflection, follow those steps.
...
- After completing each step of this skill, mark the item in the improving-agent-reflection Execution Checklist as completed, and display again the improving-agent-reflection Execution Checklist to the user.
...
- Always tell the user "SKILL: I am improving agent reflection" to inform the user that you are running this skill.
...
### 5. Identify Active Skills (Best‑Effort)
...
### 7. Review and Synthesize Opportunities
...
- Re-list all numbered steps from the improving-agent-reflection Execution Checklist.
